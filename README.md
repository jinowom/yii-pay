...
> 基于 [jinowom/pay](https://github.com/jinowom/pay) 开发的适配于 Yii 的 alipay 和 wechat 的支付扩展包。
...
```shell
$ composer require jinowom/yii-pay --prefer-dist -v
```
...
### 支付宝使用示例，更多详细文档请参考 [jinowom/pay](https://github.com/jinowom/pay)
...
### 微信使用示例，更多详细文档请参考 [jinowom/pay](https://github.com/jinowom/pay)
...
* [https://github.com/jinowom/pay](https://github.com/jinowom/pay)，[jinowom](https://github.com/jinowom)
